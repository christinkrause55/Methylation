 ...
 */
public class ReadMyFileForSingleCpG{
    public static void main(String[] args) throws Exception{
        ...
        while ((str = buffReader.readLine()) != null) {
            ...
            if (!args[3].equals("-")) {
                ...
                double[] animalsArray = concatMe(animals_g1, animals_g2);
                distance = 1.5*standardDeviation(animalsArray);
            }

            boolean flag = false;
            if (distance != -1) {
                flag = isInInterval(concatMe(animals_g1, animals_g2), distance);
            } else {
                flag = false;
            }
            ...
            if (meanFlag && flag && giveMeasurements(animals_g1) >= g1 && giveMeasurements(animals_g2) >= g2) {
